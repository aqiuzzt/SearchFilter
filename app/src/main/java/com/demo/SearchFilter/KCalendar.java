...
public class KCalendar extends ViewFlipper implements
     ...
     * @param color
     */
    public void setCalendarDayBgColorByDate(Date date, int color) {
        setCalendarDayBgColorByStr(format(date), color);
    }
     ...
     * @param color
     */
    public void setCalendarDayBgColorByStr(String date, int color) {
     ...
     * @param color
     */
    public void setCalendarDaysBgColorByList(List<String> date, int color) {
        for (int i = 0; i < date.size(); i++) {
     ...
     * @param color
     */
    public void setCalendarDayBgColorByArrayStr(String[] date, int color) {
        for (int i = 0; i < date.length; i++) {
